=begin For the purposes of this section an exception can be viewed as synonymous with an error. It's important to start developing an eye for scanning and parsing the gibberish output of an exception. This is an important skill one of the most important.
