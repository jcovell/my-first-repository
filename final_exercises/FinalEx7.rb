...
# A hash is a data structure that stores items by associated keys. Where arrays, stores items by an ordered index. Entries in ahash are often referred to as key-value pairs.  Hashes are denoted with curly braces.