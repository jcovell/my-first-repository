...
# In Ruby, the File class is a subclass of IO, a class responsible for representing bidirectional streams. Some famous IOstreams you might be familiar with include STDOUT, STDIN and STDERR, which stand for "standard output", "standard input" and "standard error", respectively.
